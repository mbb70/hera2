...
import { currentSettings, currentActivePlayers, currentActiveUnlockedPlayers, currentLockedPlayerMap } from '../selectors/tournament'
...
const mapDispatchToProps = (dispatch) => ({
  ...
  rePairPlayers: (players, settings, shuffleFn) => dispatch(e.rePairPlayers(players, settings, shuffleFn)),
